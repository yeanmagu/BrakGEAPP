...
FN._init=function(o,setOrig,start){o=go_getObject($tt0,o);
...
FN._build=function(){$cfs.data("_cfs_isCarousel",true);
...
FN._bind_events=function(){FN._unbind_events();
...
scrl.anims.push([$cf2,a_cfs,function(){_s_paddingold();
_s_paddingnew();
_s_paddingcur();
_position();
_moveitems();
...
FN._unbind_events=function(){$cfs.unbind(cf_e("",conf));
$cfs.unbind(cf_e("",conf,false));
$cfs.unbind("_cfs_triggerEvent")
};
FN._bind_buttons=function(){FN._unbind_buttons();
nv_showNavi(opts,itms.total,conf);
nv_enableNavi(opts,itms.first,conf);
...
}switch(o.fx){case"fade":case"crossfade":case"cover-fade":case"uncover-fade":$c.css("opacity",1);
$c.css("filter","");
break

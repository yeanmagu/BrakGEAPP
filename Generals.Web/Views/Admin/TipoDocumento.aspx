<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoDocumento.aspx.cs" Inherits="Generals.Web.TipoDocumento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../ControllersAngular/TipoDocumento.js"></script>  
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">    
        <div ng-controller="TipoDocumentoController" class="row" >
            <div class="row" ng-show="one"  id="Grid">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <div class="panel formgrid" >
                              <div class="panel-body">
                                   <h4 class="text-thin">Tipo Documento</h4>
										                        <hr>
                                <div class="col-md-12">                                     
                                    <div class="row">                                        
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-vcenter">
                                                    ...
                                                    <tbody>
                                                         ...
                                                         <tr ng-repeat="TipoDocumento in result | orderBy:predicate:reverse | filter:paginate| filter:search">
                                                            <td>{{TipoDocumento.ID}}</td>
                                                            <td>{{TipoDocumento.Descripcion}}</td>                                                                                      
                              
                                                            <td >
                                                                <input type="checkbox" class="checkbox form-checkbox "   ng-model="TipoDocumento.Estado" ng-true-value="{{TipoDocumento.Estado}}" />
                                               
                                                            </td>
                                                            <td>
                                                                <input type="button" value="Eliminar" class="btn btn-danger btn-icon " ng-click="removeRow(TipoDocumento.ID)" />
                                                                  <input type="button" value="Modificar" class="btn btn-mint btn-icon  icon-lg fa fa-trash" ng-model="TipoDocumento" ng-click="GetByID(TipoDocumento)" />
											                        ...
											                        <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-2">
														                        ...
														                        <label class="form-checkbox form-icon">
															                        <input type="checkbox"   ng-model="estado" ng-true-value="{{TipoDocumento.Estado}}" /> Activo
														                        </label>
													                        </div>
                                                                        </div>

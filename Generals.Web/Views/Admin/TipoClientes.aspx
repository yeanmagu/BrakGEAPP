<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoClientes.aspx.cs" Inherits="Generals.Web.TipoClientes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../ControllersAngular/Tipoclientes.js"></script>  
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">    
        <div ng-controller="TipoClienteController" class="row" >
            <div class="row" ng-show="one"  id="Grid">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <div class="panel formgrid" >
                              <div class="panel-body">
                                   <h4 class="text-thin">Tipo Clientes</h4>
										                        <hr>
                                <div class="col-md-12">                                     
                                    <div class="row">                                        
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-vcenter">
                                                    ...
                                                    <tbody>
                                                         ...
                                                         <tr ng-repeat="Tipoclientes in result | orderBy:predicate:reverse | filter:paginate| filter:search">
											                        ...
											                        <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-2">
														                        ...
														                        <label class="form-checkbox form-icon">
															                        <input type="checkbox"   ng-model="estado" ng-true-value="{{Tipoclientes.Estado}}" /> Activo
														                        </label>
													                        </div>
                                                                        </div>

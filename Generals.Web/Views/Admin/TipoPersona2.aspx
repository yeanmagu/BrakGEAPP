<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoPersona2.aspx.cs" Inherits="Generals.Web.TipoPersona2" %>
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-vcenter">
                                                    ...
                                                    <tbody>
                                                         ...
                                                         <tr ng-repeat="TipoPersona in result | orderBy:predicate:reverse | filter:paginate| filter:search">
                                                            <td>{{TipoPersona.ID}}</td>
                                                            <td>{{TipoPersona.Descripcion}}</td>                                                                                      
                              
                                                            <td >
                                                                <input type="checkbox" class="checkbox form-checkbox "   ng-model="TipoPersona.Estado" ng-true-value="{{TipoPersona.Estado}}" />
                                               
                                                            </td>
                                                            <td>
                                                                <input type="button" value="Eliminar" class="btn btn-danger btn-icon " ng-click="removeRow(TipoPersona.ID)" />
                                                                  <input type="button" value="Modificar" class="btn btn-mint btn-icon  icon-lg fa fa-trash" ng-model="TipoPersona" ng-click="GetByID(TipoPersona)" />
											                        ...
											                        <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-2">
														                        ...
														                        <label class="form-checkbox form-icon">
															                        <input type="checkbox"   ng-model="estado" ng-true-value="{{TipoPersona.Estado}}" /> Activo
														                        </label>
													                        </div>
                                                                        </div>

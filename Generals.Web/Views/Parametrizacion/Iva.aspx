<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Iva.aspx.cs" Inherits="Generals.Web.Views.Parametrizacion.Iva" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        <div ng-controller="IvaController" class="row" >
            <div class="row" ng-show="one"  id="Grid">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <div class="panel formgrid" >
                              <div class="panel-body">
                                   <h4 class="text-thin">Iva</h4>
										                        <hr>
                                <div class="col-md-12">                                     
                                    <div class="row">                                        
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-vcenter">
                                                    ...
                                                    <tbody>
                                                         ...
                                                         <tr ng-repeat="Iva in result | orderBy:predicate:reverse | filter:paginate| filter:search">
                                                            <td>{{Iva.ID}}</td>
                                                            ...
                                                            <td>
                                                                <input type="button" value="Eliminar" class="btn btn-danger btn-icon " ng-click="removeRow(Iva.ID)" />
                                                                  <input type="button" value="Modificar" class="btn btn-mint btn-icon  icon-lg fa fa-trash" ng-model="Iva" ng-click="GetByID(Iva)" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">                                                       
                                                    	<div id="demo-bvd-notempty" action="Views/Admin/forms-validation.html" class="form-horizontal">
									                        <div class="panel-body">
										                        <h4 class="text-thin">Registrar Iva</h4>
										                        <hr>
										                        <!--NOT EMPTY VALIDATOR-->
										                        <!--===================================================-->
										                        <%--<fieldset>--%>
											                        <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-3">
													                        <input type="text" class="form-control"  ng-model="porcentaje" required="required"  placeholder="porcentaje">
                                                                           
												                        </div>
                                                                        <div class="col-lg-2">
                                                                                <div class="checkbox">
														                        <label class="form-checkbox form-icon">
															                        <input type="checkbox"   ng-model="estado" ng-true-value="{{Iva.Estado}}" /> Activo
														                        </label>
													                        </div>
                                                                        </div> 
											                        </div>

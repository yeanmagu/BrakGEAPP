<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoActa.aspx.cs" Inherits="Generals.Web.Views.Parametrizacion.TipoActa" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../ControllersAngular/TipoActa.js"></script>  
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      <div ng-controller="TipoActaController" class="row" >
            <div class="row" ng-show="one"  id="Grid">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <div class="panel formgrid" >
                              <div class="panel-body">
                                   <h4 class="text-thin">Tipo Acta</h4>
										                        <hr>
                                <div class="col-md-12">                                     
                                    <div class="row">                                        
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-vcenter">
                                                    ...
                                                    <tbody>
                                                         ...
                                                         <tr ng-repeat="TipoActa in result | orderBy:predicate:reverse | filter:paginate| filter:search">
                                                            <td>{{TipoActa.ID}}</td>
                                                            <td>{{TipoActa.Descripcion}}</td>                                                                                      
                              
                                                            <td >
                                                                <input type="checkbox" class="checkbox form-checkbox "   ng-model="TipoActa.Estado" ng-true-value="{{TipoActa.Estado}}" />
                                               
                                                            </td>
                                                            <td>
                                                                <input type="button" value="Eliminar" class="btn btn-danger btn-icon " ng-click="removeRow(TipoActa.ID)" />
                                                                  <input type="button" value="Modificar" class="btn btn-mint btn-icon  icon-lg fa fa-trash" ng-model="TipoActa" ng-click="GetByID(TipoActa)" />
											                        ...
											                        <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-2">
														                        ...
														                        <label class="form-checkbox form-icon">
															                        <input type="checkbox"   ng-model="estado" ng-true-value="{{TipoActa.Estado}}" /> Activo
														                        </label>
													                        </div>
                                                                        </div>

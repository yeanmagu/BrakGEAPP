<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Paises.aspx.cs" Inherits="Generals.Web.Views.Parametrizacion.Paises" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script src="../ControllersAngular/Paises.js"></script>  
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      <div ng-controller="PaisesController" class="row" >
            <div class="row" ng-show="one"  id="Grid">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <div class="panel formgrid" >
                              <div class="panel-body">
                                   <h4 class="text-thin">Paises</h4>
										                        <hr>
                                <div class="col-md-12">                                     
                                    <div class="row">                                        
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-vcenter">
                                                    ...
                                                    <tbody>
                                                         ...
                                                         <tr ng-repeat="Paises in result | orderBy:predicate:reverse | filter:paginate| filter:search">
                                                            <td>{{Paises.ID}}</td>
                                                            <td>{{Paises.Nombre}}</td> 
                                                              <td>{{Paises.CodigoPostal}}</td>
                                                            <td >
                                                                <input type="checkbox" class="checkbox form-checkbox "   ng-model="Paises.Estado" ng-true-value="{{Paises.Estado}}" />
                                               
                                                            </td>
                                                            <td>
                                                                <input type="button" value="Eliminar" class="btn btn-danger btn-icon " ng-click="removeRow(Paises.ID)" />
                                                                  <input type="button" value="Modificar" class="btn btn-mint btn-icon  icon-lg fa fa-trash" ng-model="Paises" ng-click="GetByID(Paises)" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">                                                       
                                                    	<div id="demo-bvd-notempty" action="Views/Admin/forms-validation.html" class="form-horizontal">
									                        <div class="panel-body">
										                        <h4 class="text-thin">Registrar Paises</h4>
										                        <hr>
										                        <!--NOT EMPTY VALIDATOR-->
										                        <!--===================================================-->
										                        <%--<fieldset>--%>
                                                                     ...
                                                                     <div class="col-md-3">
                                                                      ...
                                                                      <div class="col-md-3">
                                                                         <div class="form-group">
													                      ...
													                      <input type="text" class="form-control"  ng-model="codigoPostal" required="required"  placeholder="472">
                                                                         </div>
                                                                     </div>  
                                                                      <div class="col-md-3">
                                                                         <div class="form-group">
                                                                           <label class="form-checkbox form-icon">
															                        <input type="checkbox"   ng-model="estado" ng-true-value="{{Paises.Estado}}" /> Activo
														                   </label>
                                                                         </div>
                                                                     </div>        
                                                                 </div>                

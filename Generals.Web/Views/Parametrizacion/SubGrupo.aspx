...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
       <div ng-controller="SubGrupoController" class="row" >
            <div class="row" ng-show="one"  id="Grid">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <div class="panel formgrid" >
                              <div class="panel-body">
                                   <h4 class="text-thin">SubGrupo</h4>
									<hr>
                                <div class="col-md-12">                                     
                                    <div class="row">                                        
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-vcenter">
                                                    ...
                                                    <tbody>
                                                         ...
                                                         <tr ng-repeat="SubGrupo in result | orderBy:predicate:reverse | filter:paginate| filter:search">
                                                            <td>{{SubGrupo.ID}}</td>
                                                            ...
                                                            <td>
                                                                <input type="button" value="Eliminar" class="btn btn-danger btn-icon " ng-click="removeRow(SubGrupo.ID)" />
                                                                  <input type="button" value="Modificar" class="btn btn-mint btn-icon  icon-lg fa fa-trash" ng-model="SubGrupo" ng-click="GetByID(SubGrupo)" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">                                                       
                                                    	<div id="demo-bvd-notempty" action="Views/Admin/forms-validation.html" class="form-horizontal">
									                        <div class="panel-body">
										                        <h4 class="text-thin">Registrar SubGrupo</h4>
										                        <hr>
										                        <!--NOT EMPTY VALIDATOR-->
										                        <!--===================================================-->
										                        <%--<fieldset>--%>
                                                                   <div class="row  tabla ocultar ">  
                                                                     ...
                                                                     <div class="checkbox">
														               <label class="form-checkbox form-icon">
															             <input type="checkbox" ng-model="estado" ng-true-value="{{SubGrupo.Estado}}" /> Activo
														               </label>
                                                                     </div>
                                                                     </div>
                                                                 </div>                

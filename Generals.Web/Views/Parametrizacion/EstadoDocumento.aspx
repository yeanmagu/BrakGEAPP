<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EstadoDocumento.aspx.cs" Inherits="Generals.Web.Views.Parametrizacion.EstadoDocumento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        <script src="../ControllersAngular/EstadoDocumento.js"></script>  
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div ng-controller="EstadoDocumentoController" class="row" >
            <div class="row" ng-show="one"  id="Grid">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <div class="panel formgrid" >
                              <div class="panel-body">
                                   <h4 class="text-thin">Estado Documento</h4>
									<hr>
                                <div class="col-md-12">                                     
                                    <div class="row">                                        
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-vcenter">
                                                    ...
                                                    <tbody>
                                                         ...
                                                         <tr ng-repeat="EstadoDocumento in result | orderBy:predicate:reverse | filter:paginate| filter:search">
                                                            <td>{{EstadoDocumento.ID}}</td>
                                                            <td>{{EstadoDocumento.Descripcion}}</td>
                                                            <td >
                                                                <input type="checkbox" class="checkbox form-checkbox "   ng-model="EstadoDocumento.Estado" ng-true-value="{{EstadoDocumento.Estado}}" />
                                                            </td>
                                                            <td>
                                                                <input type="button" value="Eliminar" class="btn btn-danger btn-icon " ng-click="removeRow(EstadoDocumento.ID)" />
                                                                  <input type="button" value="Modificar" class="btn btn-mint btn-icon  icon-lg fa fa-trash" ng-model="EstadoDocumento" ng-click="GetByID(EstadoDocumento)" />

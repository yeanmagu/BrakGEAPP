<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Grupo.aspx.cs" Inherits="Generals.Web.Views.Parametrizacion.Grupo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        <script src="../ControllersAngular/Grupo.js"></script>  
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      <div ng-controller="GrupoController" class="row" >
            <div class="row" ng-show="one"  id="Grid">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <div class="panel formgrid" >
                              <div class="panel-body">
                                   <h4 class="text-thin">Grupo</h4>
									<hr>
                                <div class="col-md-12">                                     
                                    <div class="row">                                        
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-vcenter">
                                                    ...
                                                    <tbody>
                                                         ...
                                                         <tr ng-repeat="Grupo in result | orderBy:predicate:reverse | filter:paginate| filter:search">
                                                            <td>{{Grupo.ID}}</td>
                                                            <td>{{Grupo.Descripcion}}</td> 
                                                           
                                                            <td >
                                                                <input type="checkbox" class="checkbox form-checkbox "   ng-model="Grupo.Estado" ng-true-value="{{Iva.Estado}}" />
                                                            </td>
                                                            <td>
                                                                <input type="button" value="Eliminar" class="btn btn-danger btn-icon " ng-click="removeRow(Grupo.ID)" />
                                                                  <input type="button" value="Modificar" class="btn btn-mint btn-icon  icon-lg fa fa-trash" ng-model="Grupo" ng-click="GetByID(Grupo)" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">                                                       
                                                    	<div id="demo-bvd-notempty" action="Views/Admin/forms-validation.html" class="form-horizontal">
									                        <div class="panel-body">
										                        <h4 class="text-thin">Registrar Grupo</h4>
										                        <hr>
										                        <!--NOT EMPTY VALIDATOR-->
										                        <!--===================================================-->
										                        <%--<fieldset>--%>
                                                                   <div class="row  tabla ocultar ">  
                                                                     ...
                                                                     <div class="checkbox">
														               <label class="form-checkbox form-icon">
															             <input type="checkbox" ng-model="estado" ng-true-value="{{Grupo.Estado}}" /> Activo
														               </label>
                                                                     </div>
                                                                     </div>
                                                                 </div>                

...
myapp.controller('ActasController', function ($scope, $http) {
    ...
    $scope.add = function () {
        ...
        if (MotivoActas.Estado != true) {
            MotivoActas.Estado = 'False';
        }

        $http.post(uri + '/Actas/Post', MotivoActas).
    ...
    $scope.Update = function () {
        ...
        $http.put(uri + '/Actas/PUT', MotivoActas).success(function (data, status, headers, config) {
            getall();
            Clean()
            Mostrar(true, false);
    ...
    $scope.GetByID = function (MotivoActas) {

        $scope.descripcion = MotivoActas.Descripcion;

        $scope.id = MotivoActas.ID;

        $scope.estado = MotivoActas.Estado;

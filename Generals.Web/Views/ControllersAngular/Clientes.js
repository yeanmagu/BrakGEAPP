...
myapp.controller('ClienteController', function ($scope, $http) {
    ...
    function getall() {
        ...
        $http.get(uri + '/Persona').success(function (response) {
    ...
    $scope.add = function ()
    {
        ...
        $http.post(uri + '/Persona/Post', Cliente).
    ...
    $scope.Update = function () {
        ...
        $http.put(uri + '/Persona/PUT', Cliente).success(function (data, status, headers, config) {
            getall();
            Clean()
            Mostrar(true, false);
    ...
    $scope.removeRow = function (codigo) {
        ...
        if (confirm('Esta Seguro que desea Eliminar el registro?')) {
            $http.delete(uri + '/Persona?Id=' + codigo).success(function (data, status, headers, config) {
                getall();
                Clean()
                Mostrar(true, false);

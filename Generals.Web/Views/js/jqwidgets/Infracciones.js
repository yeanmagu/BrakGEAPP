$(document).ready(function () {
    var Ruta = "wServicios/WebServicePvd.asmx/CargarTipoInfracciones";
    var Data;
    var h = {};
    var Invi = {};
    var array = new Array();
    ...
    function obj() {
        ...
        $.ajax({
            type: "POST",
            url: "wServicios/WebServicePvd.asmx/registrar",
    ...
    $("#jqxgrid").jqxGrid({
        ...
        columns: [
            { text: "N° Infraccion", datafield: "IdInfraccion", width: 180 },
            { text: "Infraccion", datafield: "Infraccion", width: 220 },

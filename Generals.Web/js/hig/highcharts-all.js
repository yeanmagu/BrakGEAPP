var HighchartsAdapter=function(){function k(c){function b(f,e,g){f.removeEventListener(e,g,!1)
}function d(f,e,g){g=f.HCProxiedMethods[g.toString()];
f.detachEvent("on"+e,g)
}function a(e,f){var g=e.HCEvents,t,s,v,u;
if(e.removeEventListener){t=b
}else{if(e.attachEvent){t=d
}else{return
}}f?(s={},s[f]=!0):s=g;
for(u in s){if(g[u]){for(v=g[u].length;
v--;
){t(e,u,g[u][v])
}}}}c.HCExtended||Highcharts.extend(c,{HCExtended:!0,HCEvents:{},bind:function(f,e){var q=this,g=this.HCEvents,r;
if(q.addEventListener){q.addEventListener(f,e,!1)
}else{if(q.attachEvent){r=function(o){o.target=o.srcElement||window;
e.call(q,o)
};
if(!q.HCProxiedMethods){q.HCProxiedMethods={}
}q.HCProxiedMethods[e.toString()]=r;
q.attachEvent("on"+f,r)
}}g[f]===n&&(g[f]=[]);
g[f].push(e)
},unbind:function(e,g){var f,p;
e?(f=this.HCEvents[e]||[],g?(p=HighchartsAdapter.inArray(g,f),p>-1&&(f.splice(p,1),this.HCEvents[e]=f),this.removeEventListener?b(this,e,g):this.attachEvent&&d(this,e,g)):(a(this,e),this.HCEvents[e]=[])):(a(this),this.HCEvents={})
},trigger:function(f,e){var s=this.HCEvents[f]||[],g=s.length,t,v,u;
v=function(){e.defaultPrevented=!0
};
for(t=0;
t<g;
t++){u=s[t];
...
e.target=this;
if(!e.type){e.type=f
}u.call(this,e)===!1&&e.preventDefault()
}}});
return c
}var n,h=document,l=[],i=[],m,j;
Math.easeInOutSine=function(c,b,d,a){return -d/2*(Math.cos(Math.PI*c/a)-1)+b
};
return{init:function(a){if(!h.defaultView){this._getStyle=function(c,d){var b;
return c.style[d]?c.style[d]:(d==="opacity"&&(d="filter"),b=c.currentStyle[d.replace(/\-(\w)/g,function(e,f){return f.toUpperCase()
})],d==="filter"&&(b=b.replace(/alpha\(opacity=([0-9]+)\)/,function(f,e){return e/100
})),b===""?1:b)
},this.adapterRun=function(c,d){var b={width:"clientWidth",height:"clientHeight"}[d];
if(b){return c.style.zoom=1,c[b]-2*parseInt(HighchartsAdapter._getStyle(c,"padding"),10)
}}
}if(!Array.prototype.forEach){this.each=function(c,e){for(var b=0,d=c.length;
b<d;
b++){if(e.call(c[b],c[b],b,c)===!1){return b
}}}
}if(!Array.prototype.indexOf){this.inArray=function(c,e){var b,d=0;
if(e){for(b=e.length;
d<b;
d++){if(e[d]===c){return d
}}}return -1
}
}if(!Array.prototype.filter){this.grep=function(c,e){for(var b=[],d=0,f=c.length;
d<f;
d++){e(c[d],d)&&b.push(c[d])
}return b
}
}j=function(c,d,b){this.options=d;
this.elem=c;
this.prop=b
};
j.prototype={update:function(){var c;
c=this.paths;
var d=this.elem,b=d.element;
c&&b?d.attr("d",a.step(c[0],c[1],this.now,this.toD)):d.attr?b&&d.attr(this.prop,this.now):(c={},c[this.prop]=this.now+this.unit,Highcharts.css(d,c));
this.options.step&&this.options.step.call(this.elem,this.now,this)
},custom:function(c,d,b){var e=this,g=function(p){return e.step(p)
},f;
...
g.elem=this.elem;
g()&&i.push(g)===1&&(m=setInterval(function(){for(f=0;
f<i.length;
f++){i[f]()||i.splice(f--,1)
}i.length||clearInterval(m)
},13))
},step:function(c){var d=+new Date,b;
b=this.options;
var e=this.elem,f;
if(e.stopAnimation||e.attr&&!e.element){b=!1
}else{if(c||d>=b.duration+this.startTime){this.now=this.end;
this.pos=this.state=1;
this.update();
c=this.options.curAnim[this.prop]=!0;
for(f in b.curAnim){b.curAnim[f]!==!0&&(c=!1)
}c&&b.complete&&b.complete.call(e);
b=!1
}else{e=d-this.startTime,this.state=e/b.duration,this.pos=b.easing(e,0,1,b.duration),this.now=this.start+(this.end-this.start)*this.pos,this.update(),b=!0
}}return b
}};
this.animate=function(c,d,b){var e,q="",f,r,g;
c.stopAnimation=!1;
...
for(g in d){r=new j(c,b,g),f=null,g==="d"?(r.paths=a.init(c,c.d,d.d),r.toD=d.d,e=0,f=1):c.attr?e=c.attr(g):(e=parseFloat(HighchartsAdapter._getStyle(c,g))||0,g!=="opacity"&&(q="px")),f||(f=parseFloat(d[g])),r.custom(e,f,q)
}}
},_getStyle:function(b,a){return window.getComputedStyle(b,void 0).getPropertyValue(a)
},getScript:function(c,b){var d=h.getElementsByTagName("head")[0],a=h.createElement("script");
a.type="text/javascript";
a.src=c;
a.onload=b;
d.appendChild(a)
},inArray:function(b,a){return a.indexOf?a.indexOf(b):l.indexOf.call(a,b)
},adapterRun:function(b,a){return parseInt(HighchartsAdapter._getStyle(b,a),10)
},grep:function(b,a){return l.filter.call(b,a)
},map:function(c,b){for(var d=[],a=0,e=c.length;
a<e;
a++){d[a]=b.call(c[a],c[a],a,c)
}return d
},offset:function(b){var a=document.documentElement,b=b.getBoundingClientRect();
return{top:b.top+(window.pageYOffset||a.scrollTop)-(a.clientTop||0),left:b.left+(window.pageXOffset||a.scrollLeft)-(a.clientLeft||0)}
},addEvent:function(b,a,c){k(b).bind(a,c)
},removeEvent:function(b,a,c){k(b).unbind(a,c)
},fireEvent:function(c,b,d,a){var e;
h.createEvent&&(c.dispatchEvent||c.fireEvent)?(e=h.createEvent("Events"),e.initEvent(b,!0,!0),e.target=c,Highcharts.extend(e,d),c.dispatchEvent?c.dispatchEvent(e):c.fireEvent(b,e)):c.HCExtended===!0&&(d=d||{},c.trigger(b,d));
d&&d.defaultPrevented&&(a=null);
a&&a(d)
},washMouseEvent:function(a){return a
},stop:function(a){a.stopAnimation=!0
},each:function(b,a){return Array.prototype.forEach.call(b,a)
}}
}();
...
(function(A){var l=A.Chart,y=A.addEvent,o=A.removeEvent,D=A.createElement,E=A.discardElement,j=A.css,C=A.merge,v=A.each,f=A.extend,r=Math.max,B=document,p=window,s=A.isTouchDevice,t=A.Renderer.prototype.symbols,F=A.getOptions(),k;
f(F.lang,{printChart:"Print chart",downloadPNG:"Download PNG image",downloadJPEG:"Download JPEG image",downloadPDF:"Download PDF document",downloadSVG:"Download SVG vector image",contextButtonTitle:"Chart context menu"});
F.navigation={menuStyle:{border:"1px solid #A0A0A0",background:"#FFFFFF",padding:"5px 0"},menuItemStyle:{padding:"0 10px",background:"none",color:"#303030",fontSize:s?"14px":"11px"},menuItemHoverStyle:{background:"#4572A5",color:"#FFFFFF"},buttonOptions:{symbolFill:"#E0E0E0",symbolSize:14,symbolStroke:"#666",symbolStrokeWidth:3,symbolX:12.5,symbolY:10.5,align:"right",buttonSpacing:3,height:22,theme:{fill:"white",stroke:"none"},verticalAlign:"top",width:24}};
F.exporting={type:"image/png",url:"http://export.highcharts.com/",buttons:{contextButton:{menuClassName:"highcharts-contextmenu",symbol:"menu",_titleKey:"contextButtonTitle",menuItems:[{textKey:"printChart",onclick:function(){this.print()
...
A.post=function(b,a,d){var c,b=D("form",C({method:"post",action:b,enctype:"multipart/form-data"},d),{display:"none"},B.body);
for(c in a){D("input",{type:"hidden",name:c,value:a[c]},null,b)
}b.submit();
E(b)
};
f(l.prototype,{getSVG:function(b){var a=this,d,c,h,g,e=C(a.options,b);
if(!B.createElementNS){B.createElementNS=function(i,m){return B.createElement(m)
}
}b=D("div",null,{position:"absolute",top:"-9999em",width:a.chartWidth+"px",height:a.chartHeight+"px"},B.body);
c=a.renderTo.style.width;
g=a.renderTo.style.height;
c=e.exporting.sourceWidth||e.chart.width||/px$/.test(c)&&parseInt(c,10)||600;
g=e.exporting.sourceHeight||e.chart.height||/px$/.test(g)&&parseInt(g,10)||400;
f(e.chart,{animation:!1,renderTo:b,forExport:!0,width:c,height:g});
e.exporting.enabled=!1;
e.series=[];
v(a.series,function(i){h=C(i.options,{animation:!1,showCheckbox:!1,visible:i.visible});
h.isInternal||e.series.push(h)
});
d=new A.Chart(e,a.callback);
v(["xAxis","yAxis"],function(i){v(a[i],function(u,w){var n=d[i][w],m=u.getExtremes(),q=m.userMin,m=m.userMax;
n&&(q!==void 0||m!==void 0)&&n.setExtremes(q,m,!0,!1)
})
});
...
d.destroy();
E(b);
c=c.replace(/zIndex="[^"]+"/g,"").replace(/isShadow="[^"]+"/g,"").replace(/symbolName="[^"]+"/g,"").replace(/jQuery[0-9]+="[^"]+"/g,"").replace(/url\([^#]+#/g,"url(#").replace(/<svg /,'<svg xmlns:xlink="http://www.w3.org/1999/xlink" ').replace(/ href=/g," xlink:href=").replace(/\n/," ").replace(/<\/svg>.*?$/,"</svg>").replace(/&nbsp;/g," ").replace(/&shy;/g,"­").replace(/<IMG /g,"<image ").replace(/height=([^" ]+)/g,'height="$1"').replace(/width=([^" ]+)/g,'width="$1"').replace(/hc-svg-href="([^"]+)">/g,'xlink:href="$1"/>').replace(/id=([^" >]+)/g,'id="$1"').replace(/class=([^" >]+)/g,'class="$1"').replace(/ transform /g," ").replace(/:(path|rect)/g,"$1").replace(/style="([^"]+)"/g,function(i){return i.toLowerCase()
});
return c=c.replace(/(url\(#highcharts-[0-9]+)&quot;/g,"$1").replace(/&quot;/g,"'")
},exportChart:function(b,a){var b=b||{},c=this.options.exporting,c=this.getSVG(C({chart:{borderRadius:0}},c.chartOptions,a,{exporting:{sourceWidth:b.sourceWidth||c.sourceWidth,sourceHeight:b.sourceHeight||c.sourceHeight}})),b=C(this.options.exporting,b);
A.post(b.url,{filename:b.filename||"chart",type:b.type,width:b.width||0,scale:b.scale||2,svg:c},b.formAttributes)
},print:function(){var b=this,a=b.container,d=[],c=a.parentNode,e=B.body,g=e.childNodes;
if(!b.isPrinting){b.isPrinting=!0,v(g,function(h,i){if(h.nodeType===1){d[i]=h.style.display,h.style.display="none"
}}),e.appendChild(a),p.focus(),p.print(),setTimeout(function(){c.appendChild(a);
v(g,function(h,i){if(h.nodeType===1){h.style.display=d[i]
}});
b.isPrinting=!1
},1000)
}},contextMenu:function(h,L,H,w,n,b,a){var m=this,d=m.options.navigation,K=d.menuItemStyle,g=m.chartWidth,e=m.chartHeight,c="cache-"+h,z=m[c],q=r(n,b),u,x,i,G=function(I){m.pointer.inClass(I.target,h)||x()
};
if(!z){m[c]=z=D("div",{className:h},{position:"absolute",zIndex:1000,padding:q+"px"},m.container),u=D("div",null,f({MozBoxShadow:"3px 3px 10px #888",WebkitBoxShadow:"3px 3px 10px #888",boxShadow:"3px 3px 10px #888"},d.menuStyle),z),x=function(){j(z,{display:"none"});
a&&a.setState(0);
m.openMenu=!1
},y(z,"mouseleave",function(){i=setTimeout(x,500)
}),y(z,"mouseenter",function(){clearTimeout(i)
}),y(document,"mouseup",G),y(m,"destroy",function(){o(document,"mouseup",G)
}),v(L,function(I){if(I){var J=I.separator?D("hr",null,null,u):D("div",{onmouseover:function(){j(this,d.menuItemHoverStyle)
},onmouseout:function(){j(this,K)
},onclick:function(){x();
I.onclick.apply(m,arguments)
},innerHTML:I.text||m.options.lang[I.textKey]},f({cursor:"pointer"},K),u);
m.exportDivElements.push(J)
}}),m.exportDivElements.push(u,z),m.exportMenuWidth=z.offsetWidth,m.exportMenuHeight=z.offsetHeight
}L={display:"block"};
H+m.exportMenuWidth>g?L.right=g-H-n-q+"px":L.left=H-q+"px";
w+b+m.exportMenuHeight>e&&a.alignOptions.verticalAlign!=="top"?L.bottom=e-w-q+"px":L.top=w+b-q+"px";
j(z,L);
m.openMenu=!0
},addButton:function(i){var g=this,n=g.renderer,m=C(g.options.navigation.buttonOptions,i),a=m.onclick,w=m.menuItems,u,q,b={stroke:m.symbolStroke,fill:m.symbolFill},h=m.symbolSize||12;
if(!g.btnCount){g.btnCount=0
}if(!g.exportDivElements){g.exportDivElements=[],g.exportSVGElements=[]
}if(m.enabled!==!1){var c=m.theme,d=c.states,e=d&&d.hover,d=d&&d.select,x;
delete c.states;
a?x=function(){a.apply(g,arguments)
}:w&&(x=function(){g.contextMenu(q.menuClassName,w,q.translateX,q.translateY,q.width,q.height,q);
q.setState(2)
});
m.text&&m.symbol?c.paddingLeft=A.pick(c.paddingLeft,25):m.text||f(c,{width:m.width,height:m.height,padding:0});
q=n.button(m.text,0,0,x,c,e,d).attr({title:g.options.lang[m._titleKey],"stroke-linecap":"round"});
q.menuClassName=i.menuClassName||"highcharts-menu-"+g.btnCount++;
m.symbol&&(u=n.symbol(m.symbol,m.symbolX-h/2,m.symbolY-h/2,h,h).attr(f(b,{"stroke-width":m.symbolStrokeWidth||1,zIndex:1})).add(q));
q.add().align(f(m,{width:q.width,x:A.pick(m.x,k)}),!0,"spacingBox");
k+=(q.width+m.buttonSpacing)*(m.align==="right"?-1:1);
g.exportSVGElements.push(q,u)
}},destroyExport:function(b){var b=b.target,a,c;
for(a=0;
a<b.exportSVGElements.length;
a++){if(c=b.exportSVGElements[a]){c.onclick=c.ontouchstart=null,b.exportSVGElements[a]=c.destroy()
}}for(a=0;
a<b.exportDivElements.length;
a++){c=b.exportDivElements[a],o(c,"mouseleave"),b.exportDivElements[a]=c.onmouseout=c.onmouseover=c.ontouchstart=c.onclick=null,E(c)
}}});
t.menu=function(b,a,d,c){return["M",b,a+2.5,"L",b+d,a+2.5,"M",b,a+c/2+0.5,"L",b+d,a+c/2+0.5,"M",b,a+c-1.5,"L",b+d,a+c-1.5]
};
l.prototype.callbacks.push(function(b){var a,d=b.options.exporting,c=d.buttons;
k=0;
if(d.enabled!==!1){for(a in c){b.addButton(c[a])
}y(b,"destroy",b.destroyExport)
}})
})(Highcharts);
(function(d){var e=d.each,f=function(a,b){this.init(a,b)
};
d.extend(f.prototype,{init:function(a,b){this.options=a;
this.chartOptions=b;
...
},getColumnDistribution:function(){var a=this.chartOptions,b=a&&a.chart&&a.chart.type,c=[];
e(a&&a.series||[],function(h){c.push((d.seriesTypes[h.type||b||"line"].prototype.pointArrayMap||[0]).length)
});
this.valueCount={global:(d.seriesTypes[b||"line"].prototype.pointArrayMap||[0]).length,individual:c}
},dataFound:function(){if(this.options.switchRowsAndColumns){this.columns=this.rowsToColumns(this.columns)
}this.parseTypes();
this.findHeaderRow();
this.parsed();
this.complete()
},parseCSV:function(){var a=this,b=this.options,c=b.csv,g=this.columns,h=b.startRow||0,o=b.endRow||Number.MAX_VALUE,t=b.startColumn||0,k=b.endColumn||Number.MAX_VALUE,i,u,v=0;
c&&(u=c.replace(/\r\n/g,"\n").replace(/\r/g,"\n").split(b.lineDelimiter||"\n"),i=b.itemDelimiter||(c.indexOf("\t")!==-1?"\t":","),e(u,function(j,l){var n=a.trim(j),m=n.indexOf("#")===0;
l>=h&&l<=o&&!m&&n!==""&&(n=j.split(i),e(n,function(q,p){p>=t&&p<=k&&(g[p-t]||(g[p-t]=[]),g[p-t][v]=q)
}),v+=1)
}),this.dataFound())
},parseTable:function(){var a=this.options,b=a.table,c=this.columns,h=a.startRow||0,i=a.endRow||Number.MAX_VALUE,m=a.startColumn||0,n=a.endColumn||Number.MAX_VALUE;
b&&(typeof b==="string"&&(b=document.getElementById(b)),e(b.getElementsByTagName("tr"),function(g,j){j>=h&&j<=i&&e(g.children,function(k,l){if((k.tagName==="TD"||k.tagName==="TH")&&l>=m&&l<=n){c[l-m]||(c[l-m]=[]),c[l-m][j-h]=k.innerHTML
}})
}),this.dataFound())
},parseGoogleSpreadsheet:function(){var a=this,b=this.options,c=b.googleSpreadsheetKey,g=this.columns,h=b.startRow||0,r=b.endRow||Number.MAX_VALUE,s=b.startColumn||0,k=b.endColumn||Number.MAX_VALUE,i,t;
c&&jQuery.ajax({dataType:"json",url:"https://spreadsheets.google.com/feeds/cells/"+c+"/"+(b.googleSpreadsheetWorksheet||"od6")+"/public/values?alt=json-in-script&callback=?",error:b.error,success:function(j){var j=j.feed.entry,l,m=j.length,o=0,p=0,n;
for(n=0;
n<m;
n++){l=j[n],o=Math.max(o,l.gs$cell.col),p=Math.max(p,l.gs$cell.row)
}for(n=0;
n<o;
n++){if(n>=s&&n<=k){g[n-s]=[],g[n-s].length=Math.min(p,r-h)
}}for(n=0;
n<m;
n++){if(l=j[n],i=l.gs$cell.row-1,t=l.gs$cell.col-1,t>=s&&t<=k&&i>=h&&i<=r){g[t-s][i-h]=l.content.$t
}}a.dataFound()
}})
},findHeaderRow:function(){e(this.columns,function(){});
this.headerRow=0
},trim:function(a){return typeof a==="string"?a.replace(/^\s+|\s+$/g,""):a
},parseTypes:function(){for(var a=this.columns,b=a.length,c,h,k,l;
b--;
){for(c=a[b].length;
c--;
){h=a[b][c],k=parseFloat(h),l=this.trim(h),l==k?(a[b][c]=k,k>31536000000?a[b].isDatetime=!0:a[b].isNumeric=!0):(h=this.parseDate(h),b===0&&typeof h==="number"&&!isNaN(h)?(a[b][c]=h,a[b].isDatetime=!0):a[b][c]=l===""?null:l)
}}},dateFormats:{"YYYY-mm-dd":{regex:"^([0-9]{4})-([0-9]{2})-([0-9]{2})$",parser:function(a){return Date.UTC(+a[1],a[2]-1,+a[3])
}}},parseDate:function(a){var b=this.options.parseDate,c,i,j;
b&&(c=b(a));
if(typeof a==="string"){for(i in this.dateFormats){b=this.dateFormats[i],(j=a.match(b.regex))&&(c=b.parser(j))
}}return c
},rowsToColumns:function(a){var b,c,h,k,l;
if(a){l=[];
c=a.length;
for(b=0;
b<c;
...
for(h=0;
h<k;
h++){l[h]||(l[h]=[]),l[h][b]=a[b][h]
}}}return l
},parsed:function(){this.options.parsed&&this.options.parsed.call(this,this.columns)
},complete:function(){var a=this.columns,b,c,g=this.options,h,r,s,k,i,t;
if(g.complete){this.getColumnDistribution();
a.length>1&&(b=a.shift(),this.headerRow===0&&b.shift(),b.isDatetime?c="datetime":b.isNumeric||(c="category"));
for(k=0;
k<a.length;
k++){if(this.headerRow===0){a[k].name=a[k].shift()
}}r=[];
for(k=0,t=0;
k<a.length;
t++){h=d.pick(this.valueCount.individual[t],this.valueCount.global);
s=[];
if(k+h<=a.length){for(i=0;
i<a[k].length;
i++){s[i]=[b[i],a[k][i]!==void 0?a[k][i]:null],h>1&&s[i].push(a[k+1][i]!==void 0?a[k+1][i]:null),h>2&&s[i].push(a[k+2][i]!==void 0?a[k+2][i]:null),h>3&&s[i].push(a[k+3][i]!==void 0?a[k+3][i]:null),h>4&&s[i].push(a[k+4][i]!==void 0?a[k+4][i]:null)
}}r[t]={name:a[k].name,data:s};
k+=h
}g.complete({xAxis:{type:c},series:r})
}}});
d.Data=f;
d.data=function(a,b){return new f(a,b)
};
d.wrap(d.Chart.prototype,"init",function(a,b,c){var h=this;
b&&b.data?d.data(d.extend(b.data,{complete:function(g){b.hasOwnProperty("series")&&(typeof b.series==="object"?e(b.series,function(k,l){b.series[l]=d.merge(k,g.series[l])
}):delete b.series);
b=d.merge(g,b);
a.call(h,b,c)
}}),b):a.call(h,b,c)
